...
// Custom 1.3" SH1106 OLED display for Bigtreetech SKR Mini E3 DIP
#if ENABLED(CUSTOM_E3DIP_SH1106)
  #define U8GLIB_SH1106
  #define IS_ULTIPANEL
  #define IS_ULTRA_LCD
  #define DOGLCD
...
// Custom 2.4.2" SSD1309 OLED display for Bigtreetech SKR Mini E3 DIP
#if ENABLED(CUSTOM_E3DIP_SSD1309)
  #define U8GLIB_SSD1309
  #define IS_ULTIPANEL
  #define IS_ULTRA_LCD
  #define DOGLCD
